...
public record Triangle (int a, int b, int c) {
    ...
    public boolean equals(Object o) {
        ...
        return (this.a == triangle.a && this.b == triangle.b && this.c == triangle.c)
                ...
                || (this.a == triangle.c && this.b == triangle.b && this.c == triangle.a)
                || (this.a == triangle.b && this.b == triangle.a && this.c == triangle.c)
                || (this.a == triangle.a && this.b == triangle.c && this.c == triangle.b)
